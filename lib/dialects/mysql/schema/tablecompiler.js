...
var _tablecompiler = _interopRequireDefault(
  require('../../../schema/tablecompiler')
);
...
(0, _lodash.assign)(TableCompiler_MySQL.prototype, {
  createQuery(columns, ifNot) {
    ...
    let conn = {};
    let sql =
      createStatement + this.tableName() + ' (' + columns.sql.join(', ') + ')'; // Check if the connection settings are set.
